...
//    self.title = [NSString stringWithFormat:@"Customer #%i", _sale.saleID];
...
//            
//            EDDCustomerDetailTableViewCell *customerDetailCell = [self.tableView dequeueReusableCellWithIdentifier:@"EDDCustomerDetailTableViewCell"];
//            customerDetailCell.name.numberOfLines = 1;
//            customerDetailCell.name.adjustsFontSizeToFitWidth = YES;
//            customerDetailCell.name.text = product.displayName;
//            customerDetailCell.price.text = [formatter stringFromNumber: [NSNumber numberWithFloat:product.price]];
//            cell = customerDetailCell;
//        }
//        
