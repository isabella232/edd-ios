...
#import "EDDEarningsDetailViewController.h"
#import "UIColor+Helpers.h"
#import "UIView+EDDAdditions.h"

@interface EDDEarningsViewController () {
	NSArray *items;
}

@end

@implementation EDDEarningsViewController {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
	...
	EDDEarningsDetailViewController *detailViewController = [[EDDEarningsDetailViewController alloc] initWithRange:range];	
