...
- (UIView *)headerViewForHandset:(NSInteger)section  {
    ...
    CGFloat yPosition = section == 0 ? 20.0f : 0;
    
    SAMGradientView *gradient = [[SAMGradientView alloc] initWithFrame:CGRectMake(0, yPosition, self.view.frame.size.width, 26.0f)];
    ...
    if (section == 0) {
        ...
        UIView *view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, 46.0f)];
        
        view.backgroundColor = [UIColor colorWithHexString:@"#1c5585"];
...
- (CGFloat)headerHeightForSection:(NSInteger)section {
    CGFloat height = section == 0 ? 46.0f : 26.0f;
