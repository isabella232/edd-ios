...
@interface EDDReportsViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation EDDReportsViewController
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.title = NSLocalizedString(@"Reports", @"");
}
