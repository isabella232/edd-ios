//
//  SalesFilterHeadingTableViewCell.swift
...
class SalesFilterHeadingTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        ...
        headingLabel.font = UIFont.systemFont(ofSize: 20, weight: UIFontWeightBold)
